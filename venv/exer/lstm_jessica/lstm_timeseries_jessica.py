#ref: https://www.jessicayung.com/lstms-for-time-series-in-pytorch/
#ref(source): https://github.com/jessicayung/blog-code-snippets/blob/master/lstm-pytorch/lstm-baseline.py
...
class LSTM(nn.Module):
    ...
    def forward(self, input):
        # print("input.shape = " + str(input.shape))  # [Temp] (20, 80, 1)
...
model = LSTM(lstm_input_size, hidden_size, batch_size=num_train, output_dim=output_dim, num_layers=num_layers)
